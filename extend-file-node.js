...
const { prefixId, CODES } = require(`gatsby-source-filesystem/error-utils`);
  ...
  return {
    publicURL: {
      ...
      resolve: (file, fieldArgs, context) => {
        ...
        const fileName = details.base.startsWith('cover-')
          ? `${details.base.substring(0, details.base.length - 13)}.png`
          : `${file.internal.contentDigest}/${details.base}`;
